        ...
        <DialogContent className="max-w-[1200px] bg-white dark:bg-slate-900 h-[calc(100vh-80px)] overflow-hidden flex flex-col">
          ...
          <div className="mt-3 flex-1 overflow-auto rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {drillRowsFiltradas.length === 0 ? (
                ...
                drillRowsFiltradas.map((r) => {
                  ...
                  const statusClass = isLiqu
                    ? 'bg-emerald-100 text-emerald-900 border-emerald-200 dark:bg-emerald-950/35 dark:text-emerald-200 dark:border-emerald-900'
                    : isCanc
            ...
            <div className="sticky bottom-0 z-20 grid gap-x-2 grid-cols-[140px_60px_55px_minmax(0,2.1fr)_minmax(0,2.2fr)_44px_120px_55px_55px_110px] bg-slate-50 dark:bg-slate-900/90 border-t border-slate-200 dark:border-slate-700 px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 backdrop-blur">
              ...
              <div className="text-right font-mono pr-2">{formatCurrency(drillTotals.total)}</div>
              <div />
              <div />
              <div />
            </div>
