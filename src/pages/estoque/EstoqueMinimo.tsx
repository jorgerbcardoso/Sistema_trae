      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            O módulo de <strong>Estoque Mínimo</strong> está sendo desenvolvido e estará disponível em breve.
          </p>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 dark:text-blue-400 space-y-1">
                  <li>• Definição de níveis mínimos por produto</li>
                  <li>• Alertas automáticos de reposição</li>
                  <li>• Sugestões de compra</li>
                  <li>• Histórico de rupturas</li>
                </ul>
              </div>
            </div>
          </div>
