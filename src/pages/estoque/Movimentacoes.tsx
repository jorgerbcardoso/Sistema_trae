        ...
        <div className="text-center max-w-md">
          <div className="mb-6 flex justify-center">
            <div className="rounded-full bg-blue-100 dark:bg-blue-900/20 p-6">
              <ArrowLeftRight className="w-16 h-16 text-blue-600 dark:text-blue-400" />
            </div>
          </div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            O módulo de <strong>Movimentações</strong> está sendo desenvolvido e estará disponível em breve.
          </p>
            ...
            <div className="flex gap-2 mb-2">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 dark:text-blue-400 space-y-1">
                  <li>• Registro de entradas de estoque</li>
                  <li>• Registro de saídas de estoque</li>
                  <li>• Transferências entre locais</li>
