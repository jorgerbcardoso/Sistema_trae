<?php
/**
 * API ESTOQUE - CRUD DE ESTOQUES (V2)
...
try {
    ...
    switch ($method) {
        case 'GET':
            ...
            if (isset($_GET['seq_estoque'])) {
                ...
                $query = "SELECT * FROM $tblEstoque WHERE $whereClause ORDER BY nro_estoque";
        ...
        case 'POST':
            ...
            $result = sql($g_sql, $query, false, [$unidade, $nro_estoque, $descricao, $ativo, $currentUser['username']]);
        ...
        case 'PUT':
            ...
            sql($g_sql, $query, false, [$unidade, $nro_estoque, $descricao, $ativo, $currentUser['username'], $seq]);
    ...
    error_log("Erro em /api/estoque/estoques_v2.php: " . $e->getMessage());
