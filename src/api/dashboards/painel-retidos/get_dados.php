...
$params = [];
$paramIndex = 1;
$whereConditions = ["oc.ocorrencia = '82'"];
...
$query = "
    SELECT DISTINCT ON (cte.nro_cte, cte.ser_cte)
        cte.nro_cte,
        cte.ser_cte,
    ...
    INNER JOIN {$domain}_cte_ocorrencia oc ON cte.nro_cte = oc.nro_cte AND cte.ser_cte = oc.ser_cte
    {$whereClause}
    ORDER BY cte.nro_cte DESC, cte.ser_cte DESC, oc.data_ocorrencia DESC
";
